...
- ![[Pasted image 20260130094539.png]]
...
3. Provo una ricerca per immagini specifica: ![[Pasted image 20260130112631.png]] si trova questo articolo: https://philiphaigh.co.uk/2021/09/when-will-passengers-return/ con questa immagine: ![[Pasted image 20260130112858.png]] il sedile sembra quello anche se l'adesivo è diverso ma l'immagine dell'articolo è stata scattata nel 2021 quindi ci sta. Cerchiamo di capire il resto del treno
...
6. Facendo la ricerca per immagini specifica dei sedili: ![[Pasted image 20260130113643.png]] troviamo vari riferimenti a treni LNER:
	1. https://x.com/KevinStewartSNP/status/1985413231284756751 LNER service da abeerdeen a edinburgh postata il 3 novembre 2025, in questo caso pare che anche lo sticker sia uguale: ![[Pasted image 20260130113933.png]] stesso problema che la parte alta è rossa mentre nella foto iniziale sembra grigia
	...
	5. Qui ![[Pasted image 20260130114738.png]] conferma che è un LNER (da notare che se sei in una priority seat lo scrivono e lì nel sedile davanti non c'è scritto)
...
9. Considerando che non ha nessuno dietro (lo ha scritto) è in standard class e il sedile davanti non è priority per esclusione l'unico posto possibile è **Coach G seat 6**: ![[Pasted image 20260130121005.png]]
10. In realtà la parte rossa c'è: ![[Pasted image 20260130121422.png]]
11. Per rispondere alla 1 specchio l'immagine e faccio zoom: ![[Pasted image 20260130122517.png]]
...
13. Cercando su google (NON duckduckgo) si trova qui: https://readfrom.net/sara-sheridan/page,2,629675-the_fair_botanists.html ![[Pasted image 20260130132256.png]]
